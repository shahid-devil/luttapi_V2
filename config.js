...
module.exports = {
    ...
    SHAZZIMG: process.env.LIST_IMG === undefined ? 'https://i.imgur.com/zdcqaaG.jpeg' : process.env.LIST_IMG,
    WEL_GIF: process.env.WEL_GIF === undefined ? 'https://i.imgur.com/oys9NNI.mp4' : process.env.WEL_GIF,
    GIF_BYE: process.env.GIF_BYE === undefined ? 'https://i.imgur.com/YRZnUDA.mp4' : process.env.GIF_BYE,
    BOTSHAZZ: process.env.BOT_NAME === undefined ? 'ʟᴜᴛᴛᴀᴘɪ ʙᴏᴛ' : process.env.BOT_NAME,
